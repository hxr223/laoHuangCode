...
const PACKAGE_ROOT = join(PROJECT_ROOT, "apps", "cli");
...
function main() {
  ...
  try {
    ...
    const filename = parsePackOutput(run("npm", ["pack", "--json"], { cwd: PACKAGE_ROOT }));
    tarballPath = resolve(PACKAGE_ROOT, filename);
